...
int main() 
{
    int gd = DETECT, gm, x,y,majorAxis,minorAxis;
    initgraph(&gd, &gm, NULL);
    printf("Enter center point, majoraxis and minor axis respectively");
    scanf("%d %d %d %d", &x, &y, &majorAxis, &minorAxis);

    // int x=200, y=150, majorAxis=200, minorAxis=80;
